...
public class Forno implements FornoIF {
    ...
    // Stati concreti del forno
    private enum StatoForno implements StatoFornoIF {
    ...
    private void transition(StatoFornoIF nextState) {
